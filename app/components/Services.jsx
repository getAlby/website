...
export default function Services() {
    ...
    return(
        <div className="w-full bg-albyYellow-50 px-37 pt-41 pb-38">
            <div className="flex justify-center items-center space-x-21">
                ...
                <div className="space-y-5">
                    <div className="relative bg-albyYellow-200 rounded-full w-13.5 h-12.5 mx-auto mt-8">
                ...
                <div className="space-y-5">
                    <div className="relative bg-albyYellow-200 rounded-full w-12.5 h-12.5 mx-auto mt-8">
