				...
				<div className="2xl:space-y-6 space-y-5 xl:ml-17">
					...
					<div className="flex flex-col space-y-9">
						<div className="flex gap-6">
							...
							<div className="2xl:text-xl 2xl:leading-8 font-normal xl:text-md">
						...
						<div className="flex gap-6">
							...
							<p className="2xl:text-xl 2xl:leading-8 font-normal xl:text-md">Verify if you enhanced your website successfully with the Alby browser extension</p>
						</div>
					</div>
				</div>
				...
				<div className="2xl:space-y-6 space-y-5 xl:ml-17 order-last">
					...
					<div className="flex flex-col space-y-9">
						...
						<div className="flex gap-6">
							...
							<p className="2xl:text-xl 2xl:leading-8 font-normal xl:text-md">Verify if you enhanced your Twitter profile successfully with the Alby browser extension</p>
						</div>
					</div>
				</div>
				...
				<div className="2xl:space-y-6 space-y-5 xl:ml-17">
					...
					<div className="flex flex-col space-y-9">
						...
						<div className="flex gap-6">
							...
							<p className="2xl:text-xl 2xl:leading-8 font-normal xl:text-md">Verify if you enhanced your YouTube video successfully with the Alby browser extension</p>
						</div>
					</div>
				</div>
				...
				<div className="2xl:space-y-6 space-y-5 xl:ml-17 order-last">
					...
					<div className="flex flex-col space-y-9">
						...
						<div className="flex gap-6">
							...
							<p className="2xl:text-xl 2xl:leading-8 font-normal xl:text-md">Verify if you enhanced your BitcoinTV video successfully with the Alby browser extension</p>
						</div>
					</div>
				</div>
				<div className="2xl:pt-13 xl:pt-20 image-shadow">
