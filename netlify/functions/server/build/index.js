...
// app/tailwind.css
var tailwind_default = "/build/_assets/tailwind-NR6LEEJL.css";
...
function Payment() {
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "xl:text-2xl xl:leading-8 font-normal"
  }, /* @__PURE__ */ React.createElement("p", null, "Make sure to have an og:image meta tag:", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("b", null, '<meta property="og:image" content="https://www.youre.blog/YOUR_IMAGE" />')))), /* @__PURE__ */ React.createElement("div", {
    className: "flex gap-6"
  }, /* @__PURE__ */ React.createElement("div", {
...
function Receiving() {
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "xl:px-17 xl:grid xl:grid-cols-2 pt-5 px-5 place-items-center"
  }, /* @__PURE__ */ React.createElement("div", {
    className: "xl:ml-17 space-y-3"
  }, /* @__PURE__ */ React.createElement("h3", {
    className: "2xl:text-4xl xl:leading-10 font-black text-2xl"
  }, "Your own Website"), /* @__PURE__ */ React.createElement("p", {
    className: "2xl:text-2xl font-normal text-xl text-albyColdGray-20"
    ...
    className: "xl:px-17 xl:grid xl:grid-cols-2 px-5 place-items-center"
  }, /* @__PURE__ */ React.createElement("div", {
    className: "xl:ml-17 space-y-3"
  }, /* @__PURE__ */ React.createElement("h3", {
    className: "2xl:text-4xl xl:leading-10 font-black text-2xl"
